...
export const resendStudentEmail = (id) =>
  API.post(`/admin/students/${id}/resend-email`);
...
export const updateCandidate = (id, d) =>
  API.put(`/admin/candidates/${id}`, d);
...
export const updateElectionStatus = (id, d) =>
  API.put(`/admin/elections/${id}/status`, d);
...
// VOTING
// ========================
export const validateVoteCredentials = (d) =>
  API.post('/vote/validate', d);
...
export const getInvalidAttempts = () =>
  API.get('/admin/logs/invalid-attempts');
